...
import { Star, MapPin, Clock, ThumbsUp, Calendar, Check, Heart, Share2, MessageSquare, Briefcase, Languages, GraduationCap, ChevronRight } from 'lucide-react'
import { Header } from "../../../components/header"
import { Footer } from "../../../components/footer"
import Image from "next/image"
import Link from "next/link"

// Datos de ejemplo para un freelancer
const freelancerData = {
  ...
  education: [
    { degree: "Ingeniería Informática", school: "Universidad Complutense de Madrid", year: "2015-2019" }
  ],
...
const reviews = [
  {
    ...
    rating: 5,
    content: "Alejandro fue fantástico para trabajar. Entregó el proyecto antes de lo previsto y superó todas las expectativas. Su comunicación fue excelente y supo entender perfectamente lo que necesitábamos. ¡Muy recomendable!",
  ...
  },
  {
    ...
    rating: 5,
    content: "Gran comunicación y excelentes habilidades técnicas. Alejandro nos ayudó a resolver problemas complejos con soluciones elegantes. Siempre disponible para hacer ajustes y mejoras. Volveremos a trabajar con él sin duda.",
    project: "Optimización de rendimiento"
  },
  {
    id: 3,
    ...
    rating: 4,
    content: "Alejandro es un desarrollador hábil que entregó un trabajo de calidad. Hubo algunos retrasos menores, pero el resultado final valió la pena. Buena comunicación y disposición para realizar cambios.",
    project: "Desarrollo de API"
  }
];

// Corregimos la definición de la página para Next.js 15
export default function FreelancerProfilePage() {
  // Usamos datos estáticos para simplificar
      ...
      <main className="flex-1 py-12">
        <div className="container px-4 md:px-6">
          ...
          <div className="flex items-center text-sm text-muted-foreground mb-6">
            ...
            <Link href="/categorias/desarrollo-web" className="hover:text-foreground transition-colors">Desarrollo Web</Link>
            <ChevronRight className="h-4 w-4 mx-1" />
                    ...
                    <ul className="space-y-3">
                      {freelancer.education.map((edu) => (
                        <li key={edu.school}>
                          ...
                          <div className="text-muted-foreground">{edu.school}, {edu.year}</div>
                        </li>
                      ))}
                    </ul>
                  </div>
                        ...
                        {reviews.map((review) => (
                          <div key={review.id} className="pb-6 border-b">
                            ...
                            <div className="flex items-center text-sm mt-2">
                              ...
                              <span className="text-muted-foreground">Proyecto: {review.project}</span>
                            </div>
                          </div>
                        ))}
                      </div>
