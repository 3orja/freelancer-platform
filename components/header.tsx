          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="left" className="w-[300px] sm:w-[400px]">
              <div className="px-2 py-6">
                ...
                <div className="mb-4">
                  <Input type="search" placeholder="Buscar servicios, freelancers..." className="w-full" />
                </div>
            ...
            <NavigationMenuList>
                  ...
                  <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
                    <li className="row-span-3">
                      <NavigationMenuLink asChild>
                        <a
                          ...
                          href="/"
                        >
                          <div className="mb-2 mt-4 text-lg font-medium">Encuentra el talento perfecto</div>
                    ...
                    <li>
                      <Link href="/categorias/desarrollo-web" legacyBehavior passHref>
                        <NavigationMenuLink className={navigationMenuTriggerStyle()}>Desarrollo Web</NavigationMenuLink>
                      </Link>
                    </li>
                    <li>
                      <Link href="/categorias/diseno-grafico" legacyBehavior passHref>
                        <NavigationMenuLink className={navigationMenuTriggerStyle()}>Diseño Gráfico</NavigationMenuLink>
                      </Link>
                    </li>
                    <li>
                    ...
                    <li className="row-span-3">
                      <NavigationMenuLink asChild>
                        <a
                          ...
                          href="/"
                        >
                          <div className="mb-2 mt-4 text-lg font-medium">Encuentra trabajos freelance</div>
                          <p className="text-sm leading-tight text-muted-foreground">
              ...
              <NavigationMenuItem>
                <Link href="/por-que-nosotros" legacyBehavior passHref>
                  <NavigationMenuLink className={navigationMenuTriggerStyle()}>Por Qué Nosotros</NavigationMenuLink>
                </Link>
              </NavigationMenuItem>
              <NavigationMenuItem>
